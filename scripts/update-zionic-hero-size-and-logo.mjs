...
/* ==========================================================================
   ZIONIC HERO: ENLARGED TITLE & ENLARGED LOGO SHIFTED RIGHT BY 100PX
   ========================================================================== */
...
.zionic-hero-logo-wrap {
  margin-bottom: 24px;
  margin-left: 100px; /* Shifted right by 100px */
  transition: transform 0.3s ease;
}

@media (max-width: 767px) {
  .zionic-hero-logo-wrap {
    margin-left: 0; /* Responsive fallback on mobile */
  }
}
...
// Append at the very bottom so it has absolute priority
css += '\n' + updatedHeroCss;
fs.writeFileSync('C:/nextweb/termosalud/src/css/custom.css', css, 'utf8');

console.log('Successfully updated Hero styles: title enlarged, logo enlarged and shifted right by 100px!');
