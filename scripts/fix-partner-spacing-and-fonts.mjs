...
const partnerSpacingAndTypographyCss = `
/* ==========================================================================
   ZIONIC PARTNER & PRESENTATION STAGE - PRECISION SPACING & LARGE TYPOGRAPHY
   ========================================================================== */
...
/* Right Form Column - NO UNWANTED BLANK GAPS */
...
.zionic-partner-stage-section .presentation-form-card {
  ...
  display: flex !important;
  flex-direction: column !important;
  justify-content: flex-start !important; /* CRITICAL: removes huge empty gaps */
  gap: 22px !important;
  height: 100% !important;
  box-sizing: border-box !important;
}
...
if (css.includes(markerP)) {
  css = css.substring(0, css.indexOf(markerP)) + partnerSpacingAndTypographyCss;
} else {
  css += '\n' + partnerSpacingAndTypographyCss;
}

fs.writeFileSync('C:/nextweb/termosalud/src/css/custom.css', css, 'utf8');

console.log('Successfully updated Partner section spacing and enlarged typography to match Main Page!');
