...
let body = fs.readFileSync('C:/nextweb/termosalud/scripts/exact_live_linfopress_body.html', 'utf8');
...
const newLinfopressBlock = `  // Linfopress Evolution PRO: Hero Stage + Cloned Live Body from termosalud.com.ua/linfopress/
...
const startIdx = processCode.indexOf("// Linfopress Evolution PRO: Hero Stage + Footer Only");
...
console.log('Successfully updated scripts/process-html.mjs with exact 1-to-1 cloned sections and Hero stage!');
