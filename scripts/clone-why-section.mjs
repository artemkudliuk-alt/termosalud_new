...
// Find section 8 (why section)
const whySectionRegex = /<!-- =+[\s\S]*?8\.\s*WHY LINFOPRESS[\s\S]*?<!-- EQUIPMENT PACKAGE -->/i;

const whyHtml = `<!-- ==========================================================================
           8. WHY LINFOPRESS EVOLUTION PRO (#why) - EXACT CLONE & STYLE ADAPTATION
           ========================================================================== -->
...
if (whySectionRegex.test(htmlMjs)) {
  htmlMjs = htmlMjs.replace(whySectionRegex, whyHtml);
  ...
  console.error('Could not match whySectionRegex in scripts/process-html.mjs');
}
...
console.log('Successfully updated why section styles with #54595f footer gray frames!');
