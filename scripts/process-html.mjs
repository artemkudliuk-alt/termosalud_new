...
function cleanHtml(raw, pageName) {
  ...
  if (pageName === 'index') {
    ...
    // Modern Screen 4: 21:9 Panoramic Stage (Left: Authentic Treatment Visual & Video | Right: Pastel Grey Luxury Form)
    const modernPresentationSection = `
      <!-- Screen 4: 21:9 Panoramic Studio Stage -->
      <section class="application-presentation" id="presentation-section">
        <div class="container-fluid panoramic-viewport-container">
          ...
          <!-- 21:9 Panoramic Stage Canvas -->
          <div class="panoramic-stage-card" data-aos="fade-up" data-aos-delay="100">
            
            <!-- Left Half: Authentic 21:9 Treatment Visual & Live Video Layer -->
            <div class="panoramic-media-col">
              <div class="panoramic-media-inner">
                <img src="/zionic_banner_21_9_clean.png" alt="Zionic Pro Max Clinical Treatment" class="panoramic-treatment-img">
                
                <!-- Floating Clinical Badges -->
                <div class="panoramic-video-pill">
                  <span class="live-dot-pulse"></span>
                  <span>ZIONIC PRO MAX • 3 FUSION TECHNOLOGY</span>
                </div>

                <!-- Video Modal / Action Trigger Button -->
                <a href="#popup_tech_video" data-video-url="/wp-content/uploads/2026/03/zio-1.mp4" class="panoramic-play-trigger" aria-label="Дивитися відео процедури">
                  <div class="play-btn-circle">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><polygon points="6 3 20 12 6 21 6 3"></polygon></svg>
                  </div>
                  <span class="play-btn-label">Відео процедури в дії</span>
                </a>
              </div>
            </div>

            <!-- Right Half: Pastel Grey Luxury Concierge Booking Form -->
            <div class="panoramic-form-col">
              <div class="pastel-form-container">
