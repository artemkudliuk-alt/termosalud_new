          ...
          <div class="presentation-stage-grid">
            ...
            <div class="presentation-form-col">
              <div class="presentation-form-card">
                ...
                <form class="presentation-open-form" data-form-name="Головна — Презентація Zionic" onsubmit="window.submitTermosaludLead(event, 'Головна — Презентація Zionic')">
                  <div class="form-group-item">
                    ...
                    <div class="input-with-icon">
                      ...
                      <input type="text" id="partner_name" name="name" placeholder="Наприклад: Олена, керівник клініки" required class="luxury-form-input">
                    </div>
                  </div>
                  ...
                  <div class="form-group-item">
                    ...
                    <div class="input-with-icon">
                      ...
                      <input type="text" id="partner_city" name="city" placeholder="Київ, Клініка естетичної медицини" required class="luxury-form-input">
                    </div>
                  </div>
                ...
                <div class="result-tile-card is-active is-expanded" data-case="1" data-before="/wp-content/uploads/zionic_official/case_1_before.jpg" data-after="/wp-content/uploads/zionic_official/case_1_after.jpg" data-title="Стегна та сідниці" data-num="КЕЙС 01" data-sessions="6 СЕАНСІВ" style="background: #18181b !important; border: 1px solid #27272a !important;">
                  ...
                  <div class="tile-accordion-content">
                    ...
                    <div class="mobile-tile-ba-viewport">
                      ...
                      <div class="horizontal-img-layer layer-before">
                        <img src="/wp-content/uploads/zionic_official/case_1_before.jpg" alt="До процедури Zionic" draggable="false" loading="lazy">
                        <span class="horizontal-compare-tag tag-left">ДО</span>
                      </div>
                      <div class="horizontal-divider-handle">
                        <div class="horizontal-divider-line"></div>
                        <div class="horizontal-handle-pill">
                      ...
                      <input type="range" min="0" max="100" value="50" class="horizontal-range-input" aria-label="Порівняння До та Після">
                    </div>
                  </div>
                </div>
                ...
                <div class="result-tile-card" data-case="2" data-before="/wp-content/uploads/zionic_official/case_2_before.jpg" data-after="/wp-content/uploads/zionic_official/case_2_after.jpg" data-title="Зменшення целюліту" data-num="КЕЙС 02" data-sessions="5 СЕАНСІВ" style="background: #18181b !important; border: 1px solid #27272a !important;">
                  ...
                  <div class="tile-accordion-content">
                    ...
                    <div class="mobile-tile-ba-viewport">
                      ...
                      <div class="horizontal-img-layer layer-before">
                        <img src="/wp-content/uploads/zionic_official/case_2_before.jpg" alt="До процедури Zionic" draggable="false" loading="lazy">
                        <span class="horizontal-compare-tag tag-left">ДО</span>
                      </div>
                      <div class="horizontal-divider-handle">
                        <div class="horizontal-divider-line"></div>
                ...
                <div class="result-tile-card" data-case="3" data-before="/wp-content/uploads/zionic_official/case_3_before.jpg" data-after="/wp-content/uploads/zionic_official/case_3_after.jpg" data-title="Підтяжка та ліфтинг" data-num="КЕЙС 03" data-sessions="4 СЕАНСИ" style="background: #18181b !important; border: 1px solid #27272a !important;">
                  ...
                  <div class="tile-accordion-content">
                    ...
                    <div class="mobile-tile-ba-viewport">
                      ...
                      <div class="horizontal-img-layer layer-before">
                        <img src="/wp-content/uploads/zionic_official/case_3_before.jpg" alt="До процедури Zionic" draggable="false" loading="lazy">
                        <span class="horizontal-compare-tag tag-left">ДО</span>
                      </div>
                      <div class="horizontal-divider-handle">
                        <div class="horizontal-divider-line"></div>
                ...
                <div class="result-tile-card" data-case="4" data-before="/wp-content/uploads/zionic_official/case_4_before.jpg" data-after="/wp-content/uploads/zionic_official/case_4_after.jpg" data-title="Корекція зони галіфе" data-num="КЕЙС 04" data-sessions="6 СЕАНСІВ" style="background: #18181b !important; border: 1px solid #27272a !important;">
                  ...
                  <div class="tile-accordion-content">
                    ...
                    <div class="mobile-tile-ba-viewport">
                      ...
                      <div class="horizontal-img-layer layer-before">
                        <img src="/wp-content/uploads/zionic_official/case_4_before.jpg" alt="До процедури Zionic" draggable="false" loading="lazy">
                        <span class="horizontal-compare-tag tag-left">ДО</span>
                      </div>
                      <div class="horizontal-divider-handle">
                        <div class="horizontal-divider-line"></div>
                ...
                <div class="result-tile-card" data-case="5" data-before="/wp-content/uploads/zionic_official/case_5_before.jpg" data-after="/wp-content/uploads/zionic_official/case_5_after.jpg" data-title="Живіт та боки" data-num="КЕЙС 05" data-sessions="5 СЕАНСІВ" style="background: #18181b !important; border: 1px solid #27272a !important;">
                  ...
                  <div class="tile-accordion-content">
                    ...
                    <div class="mobile-tile-ba-viewport">
                      ...
                      <div class="horizontal-img-layer layer-before">
                        <img src="/wp-content/uploads/zionic_official/case_5_before.jpg" alt="До процедури Zionic" draggable="false" loading="lazy">
                        <span class="horizontal-compare-tag tag-left">ДО</span>
                      </div>
                      <div class="horizontal-divider-handle">
                        <div class="horizontal-divider-line"></div>
                ...
                <div class="result-tile-card" data-case="6" data-before="/wp-content/uploads/zionic_official/case_6_before.jpg" data-after="/wp-content/uploads/zionic_official/case_6_after.jpg" data-title="Тонус та пружність" data-num="КЕЙС 06" data-sessions="4 СЕАНСИ" style="background: #18181b !important; border: 1px solid #27272a !important;">
                  ...
                  <div class="tile-accordion-content">
                    ...
                    <div class="mobile-tile-ba-viewport">
                      ...
                      <div class="horizontal-img-layer layer-before">
                        <img src="/wp-content/uploads/zionic_official/case_6_before.jpg" alt="До процедури Zionic" draggable="false" loading="lazy">
                        <span class="horizontal-compare-tag tag-left">ДО</span>
                      </div>
                      <div class="horizontal-divider-handle">
                        <div class="horizontal-divider-line"></div>
...
<!-- 7. CREATIVE CLINICAL INDICATIONS & CONTRAINDICATIONS MATRIX -->
      ...
      <!-- 9. TEST-DRIVE APPLICATION STAGE (RESTORED FORM WITH UPDATED TEXT) -->
      <section class="application-presentation zionic-partner-stage-section" id="test-drive">
        <div class="container">
          <div class="section-header-centered text-center" style="text-align: center !important; margin: 0 auto 44px auto !important;">
          ...
          <div class="presentation-stage-grid">
            ...
            <div class="presentation-form-col">
              <div class="presentation-form-card" id="test-drive-form">
                ...
                <!-- Form Inputs -->
                <form class="presentation-open-form" data-form-name="Zionic — Заявка на тест-драйв" onsubmit="window.submitTermosaludLead(event, 'Zionic — Заявка на тест-драйв')">
                  <div class="form-group-item">
                    <label class="form-label-text" for="z_partner_name">Ім'я</label>
                    <div class="input-with-icon">
                      <svg class="input-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"><circle cx="12" cy="7.5" r="4.5" stroke-width="1.8" fill="currentColor" fill-opacity="0.15"></circle><path d="M4.5 20C4.5 16 8 14 12 14C16 14 19.5 16 19.5 20" stroke-width="1.8" stroke-linecap="round"></path></svg>
                      <input type="text" id="z_partner_name" name="name" placeholder="Ім'я" required class="luxury-form-input">
                    </div>
                  </div>
                  ...
                  <div class="form-group-item">
                    ...
                    <div class="input-with-icon">
                      <svg class="input-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" stroke-width="1.8" fill="currentColor" fill-opacity="0.15"></path><circle cx="12" cy="10" r="3" stroke-width="1.5"></circle></svg>
                      <input type="text" id="z_partner_city" name="city" placeholder="Місто" required class="luxury-form-input">
                    </div>
                  </div>
    ...
    const modernLinfopressHtml = `
          ...
          <div class="linfopress-tech-grid">
            ...
            <div class="linfopress-tech-card" onclick="window.openLinfopressTechModal(4)">
              ...
              <div class="tech-card-body">
                ...
                <ul class="tech-card-list">
                  <li><span class="bullet-check">✓</span> Заспокоює м’язи і тканини після інтенсивної роботи.</li>
        ...
        <div class="linfopress-modal-dialog" onclick="event.stopPropagation()">
          ...
          <div id="lp-modal-tab-2" class="lp-modal-tab-content" style="display:none;">
            ...
            <div class="modal-text-content">
              ...
              <p class="modal-desc">Цикл в камерах змінюється поступово, коли попередня камера здувається, наступна надувається. На відміну від стадії розігріву, стадія «хвилі» завжди надуває всі камери, починаючи з дистальної камери і закінчуючи на проксимальній.</p>
              <p class="modal-desc">Масажний ефект, що забезпечується на цій фазі, підходить для усунення целюліту, спортивного масажу, підготовки до ліпосакції та релаксації м’язів.</p>
            </div>
          </div>
          ...
          <div id="lp-modal-tab-3" class="lp-modal-tab-content" style="display:none;">
            ...
            <div class="modal-text-content">
              ...
              <p class="modal-desc">В цій стадії застосовуються фази планомірного стискання в напрямку від дистальних до проксимальних зон, тиск зменшується при наближенні до проксимальної зони.</p>
              <p class="modal-desc">Лімфодренаж в Linfopress Evolution PRO найглибший, найінтенсивніший з можливих до 80 мм Hg. Завдяки стадії розігріву і грамотно підібраним циклам стискань сприймається пацієнтками толерантно. Без неприємних відчуттів.</p>
              <p class="modal-desc">Тиск в камерах можна налаштовувати індивідуально. Ідеально підходить для відведення надлишків рідини з тканин, для лікування целлюліту, викликаного застоєм рідини.</p>
            </div>
          </div>
          ...
          <div id="lp-modal-tab-4" class="lp-modal-tab-content" style="display:none;">
            ...
            <div class="modal-text-content">
              ...
              <p class="modal-desc">Найпопулярніший етап процедури пресотерапії. Пацієнтки із вдячністю сприймають зменшення тиску і ритмічні заспокоюючі хвилі. Відчувають, що процедура проходить на вищому рівні.</p>
      ...
      <div id="linfopress-presentation-modal-overlay" class="lp-pres-modal-overlay" onclick="window.closeLinfopressPresentationModal(event)">
        <div class="lp-pres-modal-dialog" onclick="event.stopPropagation()">
          ...
          <form class="lp-pres-modal-form" data-form-name="Linfopress — Модальне вікно безкоштовної процедури" onsubmit="window.submitTermosaludLead(event, 'Linfopress — Модальне вікно безкоштовної процедури')">
      ...
      <section class="linfopress-advantages-grid-section lp-features-section" id="advantages" style="background: #ffffff !important; position: relative !important; z-index: 20 !important; padding: 120px 0 100px 0 !important; scroll-margin-top: 90px !important;">
        ...
        <div class="container">
          <div class="section-header-centered">
            <h2 class="section-main-title" style="color: #18181b !important; text-transform: none !important; opacity: 1 !important; visibility: visible !important; display: block !important;">Переваги Linfopress Evolution PRO</h2>
            <p class="section-main-sub" style="color: #475569 !important; opacity: 1 !important; visibility: visible !important; display: block !important;">
          ...
          <div class="linfopress-faq-accordion">
            <div class="faq-accordion-card active" onclick="window.toggleLinfopressFaq(this)">
              ...
              <div class="faq-card-body" style="display:block;">
                <p>Унікальною особливістю Linfopress Evolution PRO є куртка для верхньої частини тулуба, яка здійснює лімфомасаж не тільки рук але бочків (love handle), грудної ділянки і навіть холки!</p>
              </div>
            </div>
            ...
            <div class="faq-accordion-card" onclick="window.toggleLinfopressFaq(this)">
              <div class="faq-card-header">
                ...
                <h3 class="faq-q-text">Скільки процедур потрібно для досягнення результату?</h3>
                <span class="faq-toggle-icon">+</span>
              </div>
              <div class="faq-card-body">
                <p>Кількість процедур залежить від поставленої мети. Для зняття відчуття втоми в ногах достатньо однієї процедури. Для лікування едематозного целлюліту потрібний курс з 10 процедур 2-3 процедури на тиждень.</p>
              </div>
            </div>
            ...
            <div class="faq-accordion-card" onclick="window.toggleLinfopressFaq(this)">
              <div class="faq-card-header">
                ...
                <h3 class="faq-q-text">Чи є процедура болісною?</h3>
                <span class="faq-toggle-icon">+</span>
              </div>
              <div class="faq-card-body">
                <p>Процедура Linfopress Evolution PRO є супер-комфортною завдяки етапу підготовки тканини до лімфомасажу. Пацієнтки позитивно сприймають масаж зони холки і бочків, чого ніколи не відчували на інших апаратах.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="presentation-stage-grid">
            ...
            <div class="presentation-form-col">
              <div class="presentation-form-card" id="application-form">
                ...
                <!-- Open Form Inputs -->
                <form class="presentation-open-form" data-form-name="Linfopress — Виїзний тест-драйв" onsubmit="window.submitTermosaludLead(event, 'Linfopress — Виїзний тест-драйв')">
                  <div class="form-group-item">
                    <label class="form-label-text" for="l_partner_name">Ваше ім'я та посада</label>
                    <div class="input-with-icon">
                      <svg class="input-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"><circle cx="12" cy="7.5" r="4.5" stroke-width="1.8" fill="currentColor" fill-opacity="0.15"></circle><path d="M4.5 20C4.5 16 8 14 12 14C16 14 19.5 16 19.5 20" stroke-width="1.8" stroke-linecap="round"></path></svg>
                      <input type="text" id="l_partner_name" name="name" placeholder="Наприклад: Олена, керівник клініки" required class="luxury-form-input">
                    </div>
                  </div>
                  ...
                  <div class="form-group-item">
                    ...
                    <div class="input-with-icon">
                      <svg class="input-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" stroke-width="1.8" fill="currentColor" fill-opacity="0.15"></path><circle cx="12" cy="10" r="3" stroke-width="1.5"></circle></svg>
                      <input type="text" id="l_partner_city" name="city" placeholder="Київ, Клініка естетичної медицини" required class="luxury-form-input">
                    </div>
                  </div>
  ...
  const modernGlassPopupModal = `
    ...
    <div id="popup_request" class="popup glass-popup-modal" role="dialog" aria-modal="true" aria-labelledby="glassModalTitle">
      ...
      <div class="glass-modal-card">
        ...
        <!-- Main Booking Form -->
        <form class="glass-modal-form" data-form-name="Універсальний попап — Бронювання тест-драйву" onsubmit="window.submitTermosaludLead(event, 'Універсальний попап — Бронювання тест-драйву')">
          <div class="form-group-item">
            <label class="form-label-text" for="modal_name">Ваше ім'я та посада</label>
            <div class="input-with-icon">
              <svg class="input-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"><circle cx="12" cy="7.5" r="4.5" stroke-width="1.8" fill="currentColor" fill-opacity="0.15"></circle><path d="M4.5 20C4.5 16 8 14 12 14C16 14 19.5 16 19.5 20" stroke-width="1.8" stroke-linecap="round"></path></svg>
              <input type="text" id="modal_name" name="name" placeholder="Наприклад: Наталія, головний лікар" required class="luxury-form-input">
            </div>
          </div>
