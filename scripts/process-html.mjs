...
function cleanHtml(raw, pageName) {
  ...
  if (pageName === 'index') {
    ...
    // Modern Screen 4: Application Presentation Section with Interactive Clinical Hotspots & Format Switcher
    const modernPresentationSection = `
      <!-- Screen 4: Interactive Masterclass & Test-Drive Studio -->
      <section class="application-presentation" id="presentation-section">
        <div class="container">
          ...
          <div class="presentation-grid-wrap">
            ...
            <!-- Left Column: Luxury Clinical Booking Studio Card -->
            <div class="presentation-form-card" data-aos="fade-up-right" data-aos-delay="100">
              ...
              <div class="form-card-inner">
                ...
                <div class="format-switcher-wrap">
                  ...
                  <div class="format-switcher">
                    <button type="button" class="format-tab-btn active" data-format="clinic">
                      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 21h18M5 21V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16M9 9h1M9 13h1M9 17h1M14 9h1M14 13h1M14 17h1"/></svg>
                      <span>У вашій клініці (Виїзд)</span>
                    </button>
                    <button type="button" class="format-tab-btn" data-format="showroom">
                      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20M2 12h20"/></svg>
                      <span>Шоурум Termosalud (Київ)</span>
                    </button>
                  </div>
                </div>
                ...
                <div class="form-notice">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor"><circle cx="12" cy="12" r="10" stroke-width="1.8" fill="currentColor" fill-opacity="0.12"></circle><path d="M12 7V12" stroke-width="2.2" stroke-linecap="round"></path><circle cx="12" cy="16" r="1" fill="currentColor"></circle></svg>
                ...
                <form class="presentation-clean-form" onsubmit="event.preventDefault(); document.querySelector('.form-success-toast')?.classList.add('show'); setTimeout(() => document.querySelector('.form-success-toast')?.classList.remove('show'), 4000);">
                  ...
                  <button type="submit" class="shimmer-submit-btn">
                    <span class="btn-text">ЗАБРОНЮВАТИ ТЕСТ-ДРАЙВ</span>
                  ...
                  <div class="form-trust-bullets">
                    <div class="trust-bullet-item">
                      ...
                      <span>0 ₴ за виїзд та організацію</span>
                    </div>
                    <div class="trust-bullet-item">
                      <span class="bullet-check">✓</span>
                      <span>Процедури на ваших пацієнтах</span>
                    </div>
                    <div class="trust-bullet-item">
                      <span class="bullet-check">✓</span>
            ...
            <!-- Right Column: Interactive Masterclass Stage with 3 Live Hotspots -->
            <div class="presentation-media-card" data-aos="fade-up-left" data-aos-delay="200">
              ...
              <div class="media-image-container">
                ...
                <!-- Live Interactive Hotspots on Image -->
                <!-- Hotspot 1: Doctor Hand Position -->
                <div class="clinical-hotspot hotspot-training" style="top: 32%; left: 36%;">
                  <button type="button" class="hotspot-trigger" aria-label="Постановка руки тренером">
                    <span class="hotspot-pulse"></span>
                    <span class="hotspot-core">1</span>
                  </button>
                  <div class="hotspot-card">
                    <div class="hotspot-badge">1-ON-1 ТРЕНІНГ</div>
                    <div class="hotspot-title">Постановка руки лікаря</div>
                    <p class="hotspot-text">Сертифікований методист Termosalud відпрацює правильний хват та кут ротації маніпули на ваших пацієнтах.</p>
                  </div>
                </div>

                <!-- Hotspot 2: Live Patient Results -->
                <div class="clinical-hotspot hotspot-patient" style="top: 68%; left: 62%;">
                  <button type="button" class="hotspot-trigger" aria-label="Клінічні результати">
                    <span class="hotspot-pulse"></span>
                    <span class="hotspot-core">2</span>
                  </button>
                  <div class="hotspot-card">
                    <div class="hotspot-badge">ДОКАЗОВИЙ ЕФЕКТ</div>
                    <div class="hotspot-title">Тест на ваших пацієнтах</div>
                    <p class="hotspot-text">Оцінка миттєвого лімфодренажного результату та комфорту процедури одразу після першого сеансу.</p>
                  </div>
                </div>

                <!-- Hotspot 3: Business Financial Brief -->
                <div class="clinical-hotspot hotspot-finance" style="top: 22%; right: 14%;">
                  <button type="button" class="hotspot-trigger" aria-label="Бізнес-розрахунок">
                    <span class="hotspot-pulse"></span>
                    <span class="hotspot-core">3</span>
                  </button>
                  <div class="hotspot-card">
                    <div class="hotspot-badge">ФІНАНСОВИЙ ПЛАН</div>
                    <div class="hotspot-title">Розрахунок для клініки</div>
                    <p class="hotspot-text">Аналіз вартості процедур у вашому місті та індивідуальний розрахунок окупності від 3 місяців.</p>
                  </div>
                </div>

                <!-- Floating Glass Card: Bottom Live Status -->
                <div class="floating-glass-card bottom-left">
                  <div class="live-status-dot-pulse"></div>
                  <div class="badge-content-text">
                    <div class="badge-strong">Доступно 2 виїзних слоти цього тижня</div>
                    <div class="badge-sub">Офіційний виїзд тренера з демонстраційним апаратом</div>
                  </div>
                </div>
