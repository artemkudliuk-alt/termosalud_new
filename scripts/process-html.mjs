...
function cleanHtml(raw, pageName) {
  ...
  if (pageName === 'index') {
    ...
    // Modern Screen 4: Authentic Clinical Video Showcase & Swiss Luxury Concierge Studio
    const modernPresentationSection = `
      <!-- Screen 4: Authentic Clinical Video Showcase & Concierge Booking Studio -->
      <section class="application-presentation" id="presentation-section">
        <div class="container">
          ...
          <div class="presentation-header" data-aos="fade-up">
            ...
            <h2>Замовте презентацію та практичний тест-драйв</h2>
          ...
          <div class="presentation-grid-wrap">
            ...
            <!-- Left Column: Pure Luxury Swiss Concierge Form Card (Light & Crisp) -->
            ...
            <!-- Right Column: Authentic Clinical Video Player Stage + 3 Key Clinical Pillars -->
            <div class="presentation-showcase-column" data-aos="fade-up-left" data-aos-delay="200">
              
              <!-- Video Frame Stage -->
              <div class="video-showcase-card">
                <div class="video-top-bar">
                  <div class="live-record-indicator">
                    <span class="live-dot-blink"></span>
                    <span>КЛІНІЧНА ПРЕЗЕНТАЦІЯ ТА ТЕСТ</span>
                  </div>
                  <span class="video-tech-tag">ZIONIC & LINFOPRESS</span>
                </div>
                
                <div class="video-wrapper-inner">
                  <video autoplay loop muted playsinline class="authentic-presentation-video">
                    <source src="/wp-content/themes/zionic/assets/images/presentation-video.mp4" type="video/mp4">
                  </video>
                </div>
              </div>

              <!-- 3 Tangible Clinical Benefit Modules -->
              <div class="clinical-deliverables-grid">
                
                <div class="deliverable-card">
                  <div class="deliverable-num">01</div>
                  <div class="deliverable-content">
                    <h4>Практика на ваших пацієнтах</h4>
                    <p>Лікарі вашої клініки особисто оцінять миттєвий лімфодренажний ефект та комфорт пацієнта під час процедури.</p>
                  </div>
                </div>
                ...
                <div class="deliverable-card">
                  ...
                  <div class="deliverable-content">
                    <h4>Постановка руки лікаря 1-on-1</h4>
                    <p>Сертифікований методист Termosalud проведе повне навчання персоналу правильному хвату та куту ротації маніпул.</p>
                  </div>
                </div>
                ...
                <div class="deliverable-card">
                  ...
                  <div class="deliverable-content">
                    <h4>Індивідуальний фінплан клініки</h4>
                    <p>Розрахуємо середній чек процедури та точний графік виходу на прибуток з урахуванням площі вашого кабінету.</p>
                  </div>
                </div>
