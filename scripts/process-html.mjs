...
function cleanHtml(raw, pageName) {
  ...
  if (pageName === 'index') {
    ...
    const modernScreen2Section = `
      <!-- Screen 2: Interactive Video Showcase (2screen.mp4) with Diagonal Glassmorphic Overlays -->
      <section id="our-products" class="our-prods-video-showcase">
        <div class="video-showcase-bg">
          <video autoplay loop muted playsinline class="showcase-video-element" preload="auto">
            <source src="/wp-content/uploads/2026/03/2screen.mp4" type="video/mp4">
            <source src="/2screen.mp4" type="video/mp4">
          </video>
          <!-- Subtle Dark Translucent Medical Vignette Overlay -->
        ...
        <div class="showcase-container">
          ...
          <div class="showcase-header" data-aos="fade-up">
            <div class="showcase-badge">
              ...
              <span>Інноваційні технології Termosalud</span>
            </div>
            <h2 class="showcase-title">Флагманське обладнання для клінік</h2>
            <p class="showcase-sub">Преміальні апаратні рішення з високою рентабельністю, швидкою окупністю та доведеною клінічною ефективністю</p>
          </div>

          <!-- Interactive Glassmorphic Cards Positioned to Respect Diagonal Split -->
          <div class="showcase-interactive-stage">
            
            <!-- Top-Right Card: ZIONIC (MARP System) -->
            <div class="showcase-glass-card card-zionic" data-aos="fade-left" data-aos-delay="150">
              <div class="glass-card-halo"></div>
              <div class="glass-card-inner">
                <div class="card-pill-meta">
                  <span class="tech-tag tag-zionic">MARP + RF Technology</span>
                  <span class="origin-tag">Made in Spain</span>
                </div>
                <h3 class="device-title">ZIONIC <span class="device-sub">MARP SYSTEM</span></h3>
                <p class="device-desc">
                  Перша у світі запатентована технологія: комбінація активного ротаційного глибокого масажу та резистивного RF-прогріву.
                </p>
                <ul class="device-bullets">
                  <li>
                    ...
                    <span>Одночасна дія: ліполіз, ліфтинг та тонус</span>
                  </li>
                  <li>
                    <span class="check-icon">
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="20 6 9 17 4 12"></polyline></svg>
                    </span>
                    <span>Безболісно та без реабілітації для пацієнта</span>
                  </li>
                  <li>
                    <span class="check-icon">
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="20 6 9 17 4 12"></polyline></svg>
                    </span>
                    <span>Швидка окупність від 3 до 4 місяців</span>
                  </li>
                </ul>
                <div class="card-btn-row">
                  <a href="/zionic/" class="showcase-btn-primary">
                  ...
                  <button class="showcase-btn-secondary header-btn" data-target="#popup_request">Тест-драйв</button>
                </div>
              </div>
            </div>

            <!-- Bottom-Left Card: Linfopress Evolution PRO -->
            <div class="showcase-glass-card card-linfopress" data-aos="fade-right" data-aos-delay="150">
              <div class="glass-card-halo"></div>
              <div class="glass-card-inner">
                <div class="card-pill-meta">
                  <span class="tech-tag tag-linfopress">Пресотерапія 4-го покоління</span>
                  <span class="origin-tag">24 Сектори</span>
                </div>
                <h3 class="device-title">Linfopress <span class="device-sub">EVOLUTION PRO</span></h3>
                <p class="device-desc">
                  Професійна система циклічної пресотерапії для ефективного лімфодренажу, моделювання контурів тіла та детоксу.
                </p>
                <ul class="device-bullets">
                  <li>
                    <span class="check-icon">
                  ...
                  <li>
                    ...
                    <span>Медична сертифікація безпеки CE Medical</span>
                  </li>
                  <li>
                    <span class="check-icon">
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="20 6 9 17 4 12"></polyline></svg>
                    </span>
                    <span>Високий попит та щоденний прибуток</span>
                  </li>
                </ul>
                <div class="card-btn-row">
                  <a href="/linfopress/" class="showcase-btn-primary">
                    <span>Дізнатись більше</span>
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>
                  </a>
                  <button class="showcase-btn-secondary header-btn" data-target="#popup_request">Тест-драйв</button>
